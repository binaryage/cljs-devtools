...
(def type-color "rgba(140, 140, 255, 1)")
...
(def instance-custom-printing-background "rgba(140, 200, 255, 0.3)")

(def body-line-common-style "")

(def common-type-header-style (str "background-color:" type-color ";"
                                   "color: #eee;"
...
(def default-prefs
  {:features-to-install                             :default
   ...
   :instance-custom-printing-style                  (str "border-left: none;"
                                                         "padding: 0 2px 0 4px;"
                                                         "background-color:" instance-custom-printing-background ";"
                                                         "border-radius: 0 2px 2px 0;")
   :instance-type-header-style                      (str common-type-header-style
                                                         "border-radius: 2px 0 0 2px;")
   :instance-type-with-custom-printing-header-style (str
                                                      )
   :instance-value-style                            (str "border-radius: 0 2px 2px 0;"
                                                         "background-color: " instance-value-background ";")
   :instance-value-with-custom-printing-style       (str "border-radius: 0;"
                                                         "background-color: " instance-value-background ";")
